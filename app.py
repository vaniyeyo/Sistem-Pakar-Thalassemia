...
def route_rbr():
    ...
    presentase = (total_bobot / total_gejala) * 100
...
def route_cbr():
    ...
    if request.method == 'POST':
        ...
        filtered_gejala_selected = {gejala: bobot for gejala, bobot in gejala_selected.items() if bobot != 0}
        filtered_gejala_lama = {gejala: bobot for gejala, bobot in gejala_lama.items() if bobot != 0}
    ...
    return render_template('proses-diagnosa-cbr.html.html')
